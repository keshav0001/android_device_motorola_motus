...
mkdir -p ../../../vendor/motorola/$DEVICE/proprietary/touchpad
mkdir -p ../../../vendor/motorola/$DEVICE/proprietary/minipad
...
unzip -j -o ../../../${DEVICE}_update.zip system/etc/touchpad/50/saveconfig.cfg -d ../../../vendor/motorola/$DEVICE/proprietary/touchpad
unzip -j -o ../../../${DEVICE}_update.zip system/etc/touchpad/50/touchpad.cfg -d ../../../vendor/motorola/$DEVICE/proprietary/touchpad
unzip -j -o ../../../${DEVICE}_update.zip system/etc/touchpad/50/touchpad.enc -d ../../../vendor/motorola/$DEVICE/proprietary/touchpad
unzip -j -o ../../../${DEVICE}_update.zip system/etc/minipad/104/minipad.cfg -d ../../../vendor/motorola/$DEVICE/proprietary/minipad
unzip -j -o ../../../${DEVICE}_update.zip system/etc/minipad/104/minipad.enc -d ../../../vendor/motorola/$DEVICE/proprietary/minipad
unzip -j -o ../../../${DEVICE}_update.zip system/etc/minipad/104/saveconfig.cfg -d ../../../vendor/motorola/$DEVICE/proprietary/minipad
...
PRODUCT_COPY_FILES += \\
    ...
    vendor/motorola/__DEVICE__/proprietary/touchpad/touchpad.enc:system/etc/touchpad/50/touchpad.enc \\
    vendor/motorola/__DEVICE__/proprietary/touchpad/touchpad.cfg:system/etc/touchpad/50/touchpad.cfg \\
    vendor/motorola/__DEVICE__/proprietary/touchpad/saveconfig.cfg:system/etc/touchpad/50/saveconfig.cfg \\
    vendor/motorola/__DEVICE__/proprietary/minipad/minipad.cfg:system/etc/minipad/104/minipad.cfg \\
    vendor/motorola/__DEVICE__/proprietary/minipad/minipad.enc:system/etc/minipad/104/minipad.enc \\
    vendor/motorola/__DEVICE__/proprietary/minipad/saveconfig.cfg:system/etc/minipad/104/saveconfig.cfg \\
    ...
    vendor/motorola/__DEVICE__/proprietary/libdsnd.so:system/lib/libdsnd.so \\
